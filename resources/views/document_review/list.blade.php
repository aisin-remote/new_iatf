    ...
    <script>
        $(document).ready(function() {
            ...
            `;
                                ...
                                buttonsHtml += `
                <a href="/storage/document_review/${data.file}" class="btn btn-info btn-sm">
        ...
        @role('admin')
            <button class="btn btn-warning btn-sm btn-edit" data-toggle="modal" data-target="#editModal" data-id="${data.id}" data-name="${data.name}" data-department="${data.department}" data-obsolete="${data.review}" data-set_reminder="${data.set_reminder}" data-comment="${data.comment}">
