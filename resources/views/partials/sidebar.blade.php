<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        @role('guest')
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#proses" aria-expanded="false" aria-controls="proses">
                    <i class="fa-solid fa-file-lines" style="margin-right: 14px"></i>
