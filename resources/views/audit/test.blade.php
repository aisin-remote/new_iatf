                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('masterdata.audit') }}">Buttons</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('masterdata.itemAudit') }}">Dropdowns</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('masterdata.auditControl') }}">Typography</a>
                                </li>
                            </ul>
                        </div>
                    </li>
